# How to contribute to SYcozyapp?
...
- What is the version of the Cozy SYcozyapp?
...
```
$ git clone github.com/sandruse1/sy_cozyapp.git
$ cd sy_cozyapp
$ git remote add fork git://github.com/yourusername/sy_cozyapp.git
```
...
Go to https://github.com/yourusername/sy_cozyapp and select your branch. Click the 'Pull Request' button and fill out the form.
...
The SYcozyapp is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/sandruse1/sy_cozyapp/issues/new
...
[localization]: https://github.com/sandruse1/sy_cozyapp/blob/master/README.md#localization
